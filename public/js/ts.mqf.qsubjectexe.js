...
tsQsbjExe.init = function(onSucc, onErr)
{
    ...
    tsQsbjTool._init.call(this
        ,function(){
            //  주제-TO-Q MAP 로딩 - 없는 경우도 있을 수 있음
            _this._cfg.api.stQToQui.call(_this, /*all*/undefined
                ,function (key, /*{}*/data){
                    _this.mapQ2Ui = data;
                    loadCnt ++;
                    onLoad();
            ...
            //  QUI DATA 로딩
            _this._cfg.storage.quiData.call(_this
                ,function (/*{}*/quiData){
...
tsQsbjExe.subjectMakeContent = function(/*Array*/sbjIds, /*{}*/qsetui)/*Content{}*/
{
    //  실행 - 'Format', 'theme'은 문항SET UI가 채움. Qtarget, Qtarget는 undefined(무제한)로 지정
    var Content = {
        "Type":"qsetGen", "IdQsetUi":qsetui.id, "IdSubject":sbjIds, "Qtarget":{}, "QuiType":[]
    }
...
tsQsbjExe.subjectGetTerminalNode = function(subjectID)/*{sbjId,...}*/
{
    ...
    function traverseSubject(id, /*{}*/map)
    {
        ...
        if (!(node.child&&node.child.length)){ // 말단 Node이면 추가
            map[id] = true;
        }
        else{
